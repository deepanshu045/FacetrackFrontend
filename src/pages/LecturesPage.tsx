...
import { cancelLecture, fetchClassSections, fetchLectures, fetchTeachers } from "../services/api";
...
export default function LecturesPage() {
  ...
  return <PageWrap>
    <div className="mb-6">
      ...
      <p className="mt-1 text-sm text-slate-400">These are actual dated lecture instances generated from the Weekly Schedule.</p>
    </div>
    ...
    <div className="mb-4 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 md:flex-row md:items-center">
      <div className="flex-1">
        ...
        <select id="lecture-class-filter" value={classFilter} onChange={e => setClassFilter(e.target.value)} className="w-full rounded-xl border border-white/10 bg-[#0F172A] px-3 py-2.5 text-sm text-white">
